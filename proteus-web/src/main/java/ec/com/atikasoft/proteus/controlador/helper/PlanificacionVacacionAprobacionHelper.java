/*
 *  PLanificacionVacacionAprobacionHelper.java
 ...
 */
@ManagedBean(name = "planificacionVacacionAprobacionHelper")
@SessionScoped
public class PlanificacionVacacionAprobacionHelper extends CatalogoHelper {
    ...
    private Double totalSaldoVacacion;

    /**
     * Constructor por defecto.
     */
    public PlanificacionVacacionAprobacionHelper() {
        super();
        iniciador();
    }
...
//
//    /**
//     * @param esAprobacion the esAprobacion to set
//     */
...
//    }
    ...
    /**
     * @return the totalSaldoVacacion
     */
    public Double getTotalSaldoVacacion() {
        return totalSaldoVacacion;
    }

    /**
     * @param totalSaldoVacacion the totalSaldoVacacion to set
     */
    public void setTotalSaldoVacacion(Double totalSaldoVacacion) {
        this.totalSaldoVacacion = totalSaldoVacacion;
    }
