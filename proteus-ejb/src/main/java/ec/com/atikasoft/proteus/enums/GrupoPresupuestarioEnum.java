...
/**
 * Grupos de gastos usados.
 *
 * @author Liliana Rodríguez <liliana.rodriguez@markasoft.ec>
 */
public enum GrupoPresupuestarioEnum {
     ...
     * @param descripcion
     */
    private GrupoPresupuestarioEnum(final String codigo, final String descripcion) {
        this.codigo = codigo;
    ...
    public static String obtenerDescripcion(final String codigo) {
        String des = null;
        for (GrupoPresupuestarioEnum cc : values()) {
