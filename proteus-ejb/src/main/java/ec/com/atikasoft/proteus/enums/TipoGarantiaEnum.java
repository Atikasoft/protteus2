...
public enum TipoGarantiaEnum {
    ...
    /** 
     *<E>stabilidad Laboral.
     */
    ESTABILIDAD_LABORAL("E", "ESTABILIDAD LABORAL"),
    /**
     *  <R>mu.
     */
    RMU("R", "RMU"),
     ...
     * <S>iempre garante.
     */
    SIEMPRE_GARANTE("S", "SIEMPRE GARANTE");
    /**
     ...
     * @param descripcion
     */
    private TipoGarantiaEnum(String codigo, String descripcion) {
        this.codigo = codigo;
    ...
    public static String obtenerDescripcion(final String codigo) {
        String des = null;
        for (TipoGarantiaEnum cc : values()) {
