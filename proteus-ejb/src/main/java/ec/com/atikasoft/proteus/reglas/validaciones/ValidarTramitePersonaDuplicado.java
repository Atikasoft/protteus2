...
/**
 * No permitir el registro de un tramite si tiene otro en curso, El sistema automaticamente controlara que no se permita
 * el registro de un tramite si la persona tiene otro tramite en curso
 *
...
@Stateless
@LocalBean
public class ValidarTramitePersonaDuplicado extends ReglaAbstracta {

    /**
     * Logger de la clase.
     */
    private static final Logger LOG = Logger.getLogger(ValidarTramitePersonaDuplicado.class.getCanonicalName());

    /**
     * Identificador de la regla.
     */
    public static final String CODIGO_REGLA = "VALPEDU";
     ...
     */
    public ValidarTramitePersonaDuplicado() {
        super();
    }
    ...
    public void validar(final Map<String, Object> parametros, final List<ReglaMensaje> mensajes,
        ...
        LOG.fine("**** Validacion de personas duplicados.");
        ...
        try {
            ...
            if (movimiento.getNumeroIdentificacion() == null) {
                ...
                List<Movimiento> movimientos = movimientoDao.buscarPersonasDuplicadas(movimiento.getTipoIdentificacion().
                        substring(0, 1), movimiento.getNumeroIdentificacion(), movimiento.getId());
                if (!movimientos.isEmpty()) {
                    StringBuilder msg = new StringBuilder();
                    msg.append("Ciudadano con cédula No ").append(movimiento.getNumeroIdentificacion());
