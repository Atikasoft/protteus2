 ...
 */
public enum EstadoVacacionEnum {
     ...
     *
     * @param codigo codigo del estado de vacacion
     * @param descripcion descripcion del estado de vacacion
     */
    private EstadoVacacionEnum(String codigo, String descripcion) {
        this.codigo = codigo;
    ...
    public static String obtenerDescripcion(final String codigo) {
        String des = null;
        for (EstadoVacacionEnum cc : values()) {
