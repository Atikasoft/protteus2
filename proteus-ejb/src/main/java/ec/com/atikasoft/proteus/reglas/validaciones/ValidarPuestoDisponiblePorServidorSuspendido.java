...
@Stateless
@LocalBean
public class ValidarPuestoDisponiblePorServidorSuspendido extends ReglaAbstracta {

    /**
     * Logger de la clase.
     */
    private static final Logger LOG =
            Logger.getLogger(ValidarPuestoDisponiblePorServidorSuspendido.class.getCanonicalName());

    /**
     * Identificador de la regla.
     */
    public static final String CODIGO_REGLA = "VALPUEDISSERSUS";
     ...
     */
    public ValidarPuestoDisponiblePorServidorSuspendido() {
        super();
    }
    ...
    public void validar(final Map<String, Object> parametros, final List<ReglaMensaje> mensajes,
        ...
        LOG.fine("**** Validar puesto disponible por servidor suspendido.");
        ...
        try {
            ...
            if (movimiento.getNumeroIdentificacion() == null) {
                ...
                ParametroGlobal pTipoMovimiento =
                        buscarParametroGlobal(ParametroGlobalEnum.NEMONICO_TIPO_MOVIMIENTO_SUSPENSION_TEMPORAL_SIN_GOCE_REMUNERACION.
                ...
                if (!existe) {
                    ...
                    msg.append("SUSPENSIÓN TEMPORAL SIN GOCE DE REMUNERACIÓN");
