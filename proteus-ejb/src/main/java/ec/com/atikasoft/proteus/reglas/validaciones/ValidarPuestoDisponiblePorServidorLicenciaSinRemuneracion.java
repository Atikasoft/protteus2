...
@Stateless
@LocalBean
public class ValidarPuestoDisponiblePorServidorLicenciaSinRemuneracion extends ReglaAbstracta {

    /**
     * Logger de la clase.
     */
    private static final Logger LOG =
            Logger.getLogger(ValidarPuestoDisponiblePorServidorLicenciaSinRemuneracion.class.getCanonicalName());

    /**
     * Identificador de la regla.
     */
    public static final String CODIGO_REGLA = "VALPUEDISSERLISINREM";
     ...
     */
    public ValidarPuestoDisponiblePorServidorLicenciaSinRemuneracion() {
        super();
    }
    ...
    public void validar(final Map<String, Object> parametros, final List<ReglaMensaje> mensajes,
        ...
        LOG.fine("**** Validar puesto disponible por servidor con licencia sin remuneracion.");
        ...
        try {
            ...
            if (movimiento.getNumeroIdentificacion() == null) {
                ...
                ParametroGlobal pTipoMovimiento =
                        buscarParametroGlobal(ParametroGlobalEnum.NEMONICO_TIPO_MOVIMIENTO_LICENCIA_SIN_REMUNERACION.
                ...
                if (!existe) {
                    ...
                    msg.append("LICENCIA SIN REMUNERACIÓN");
