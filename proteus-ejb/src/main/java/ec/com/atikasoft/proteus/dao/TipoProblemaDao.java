...
@LocalBean
@Stateless
public class TipoProblemaDao extends GenericDAO<TipoProblema, Long> {

    /**
     * Logger de clases.
     */
    private static final Logger LOG = Logger.getLogger(TipoProblemaDao.class.getName());

    /**
     * Constructor sin argumentos.
     */
    public TipoProblemaDao() {
        super(TipoProblema.class);
    }
}