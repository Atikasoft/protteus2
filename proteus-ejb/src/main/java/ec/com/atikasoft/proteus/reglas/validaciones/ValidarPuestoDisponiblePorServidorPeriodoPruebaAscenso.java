...
@Stateless
@LocalBean
public class ValidarPuestoDisponiblePorServidorPeriodoPruebaAscenso extends ReglaAbstracta {

    /**
     * Logger de la clase.
     */
    private static final Logger LOG =
            Logger.getLogger(ValidarPuestoDisponiblePorServidorPeriodoPruebaAscenso.class.getCanonicalName());

    /**
     * Identificador de la regla.
     */
    public static final String CODIGO_REGLA = "VALPUEDISSERPERPRAS";
     ...
     */
    public ValidarPuestoDisponiblePorServidorPeriodoPruebaAscenso() {
        super();
    }
    ...
    public void validar(final Map<String, Object> parametros, final List<ReglaMensaje> mensajes,
        ...
        LOG.fine("**** Validar puesto disponible por servidor periodo prueba de ascenso.");
        ...
        try {
            ...
            if (movimiento.getNumeroIdentificacion() == null) {
                ...
                ParametroGlobal pTipoMovimiento =
                        buscarParametroGlobal(ParametroGlobalEnum.NEMONICO_TIPO_MOVIMIENTO_PERIODO_PRUEBA_ASCENSO.
                ...
                if (!existe) {
                    ...
                    msg.append("PERIODO DE PRUEBA POR ASCENSO.");
