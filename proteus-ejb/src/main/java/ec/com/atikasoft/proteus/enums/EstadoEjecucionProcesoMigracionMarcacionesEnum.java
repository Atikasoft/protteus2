 ...
 */
public enum EstadoEjecucionProcesoMigracionMarcacionesEnum {
     ...
     * @param descripcion
     */
    private EstadoEjecucionProcesoMigracionMarcacionesEnum(String codigo, String descripcion) {
        this.codigo = codigo;
    ...
    public static String obtenerDescripcion(final String codigo) {
        String des = null;
        for (EstadoEjecucionProcesoMigracionMarcacionesEnum cc : values()) {
