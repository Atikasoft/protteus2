...
/**
 * Control amonestación Verbal (REGLA1): Si una persona tiene 2 amonestaciones verbales en el ultimo anio de labores
 * sistema no le permite el ingreso de otro movimiento del mismo tipo y le indica que debe realizar una amonestación
 * escrita Calculo de año calendario: inicia desde la fecha que el servidor ingresó a la institución (fecha de ingreso +
 * 1 año menos 1 día).
 *
...
@Stateless
@LocalBean
public class ValidarAmonestacionVerbal extends ReglaAbstracta {

    /**
     * Logger de la clase.
     */
    private static final Logger LOG = Logger.getLogger(ValidarAmonestacionVerbal.class.getCanonicalName());

    /**
     * Identificador de la regla.
     */
    public static final String CODIGO_REGLA = "VALAMVER";
     ...
     */
    public ValidarAmonestacionVerbal() {
        super();
    }
    ...
    public void validar(final Map<String, Object> parametros, final List<ReglaMensaje> mensajes,
        ...
        LOG.fine("**** Validacion de amonestacion verbal.");
        Movimiento m = null;
        try {
            ...
            if (m.getNumeroIdentificacion() == null) {
                registrarMensaje(UtilCadena.concatenar("No existe el número de identificación de la persona."),
                        Boolean.TRUE, mensajes, regla, m);
            } else if (m.getTipoIdentificacion() == null) {
                registrarMensaje(UtilCadena.concatenar("No existe el tipo de identificación de la persona."),
                        Boolean.TRUE, mensajes, regla, m);
                ...
                if (seleccionado != null) {
                    ...
                    if (movimientos.size() >= 2) {
                        ...
                        msg.append(", ya cuenta con 2 amonestaciones verbales en su último periodo de labores, ");
                        msg.append("debe ingresar una amonestación escrita");
