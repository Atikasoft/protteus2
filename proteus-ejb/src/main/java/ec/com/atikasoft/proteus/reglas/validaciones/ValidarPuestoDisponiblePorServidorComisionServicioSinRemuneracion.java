...
/**
 * Puesto esta disponible porque servidor tiene comision de servicios sin remuneracion.
 *
 *
...
@Stateless
@LocalBean
public class ValidarPuestoDisponiblePorServidorComisionServicioSinRemuneracion extends ReglaAbstracta {
    ...
    private static final Logger LOG =
            Logger.getLogger(
            ValidarPuestoDisponiblePorServidorComisionServicioSinRemuneracion.class.getCanonicalName());

    /**
     * Identificador de la regla.
     */
    public static final String CODIGO_REGLA = "VALPUEDISSERCSSINREM";
     ...
     */
    public ValidarPuestoDisponiblePorServidorComisionServicioSinRemuneracion() {
        super();
    }
    ...
    public void validar(final Map<String, Object> parametros, final List<ReglaMensaje> mensajes,
        ...
        LOG.fine("**** Validar puesto disponible por servidor con comision de servicio sin remuneracion.");
        ...
        try {
            ...
            if (movimiento.getNumeroIdentificacion() == null) {
                ...
                if (!existe) {
                    ...
                    msg.append("COMISIÓN DE SERVICIO SIN REMUNERACIÓN");
