 ...
 */
public enum OrigenVariableEnum {
     ...
     * Campos de Acceso.
     */
    CAMPOS_ACCESO("C", "CAMPOS DE ACCESO"),
    
    /**
     * Preconstruidos.
     */
    PRECONSTRUIDOS("P", "PRECONSTRUIDOS");
 ...
 * @param descripcion 
 */
    private OrigenVariableEnum(String codigo, String descripcion) {
        this.codigo = codigo;
 ...
 /**
    ...
    public static String obtenerDescripcion(final String codigo) {
        String des = null;
        for (OrigenVariableEnum cc : values()) {
