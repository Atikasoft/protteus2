 ...
 */
public enum EstadoReclutamientoEnum {
     ...
     * @param descripcion
     */
    private EstadoReclutamientoEnum(String codigo, String descripcion) {
        this.codigo = codigo;
    ...
    public static String obtenerDescripcion(final String codigo) {
        String des = null;
        for (EstadoReclutamientoEnum cc : values()) {
