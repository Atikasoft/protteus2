...
@Getter
@Setter
public class GenerarAccionPersonalOtraInstitucionTerminacion {
     ...
     *
     */
    private final String NOMBRE_ARCHIVO = "ACCION_PERSONAL_OTRAS_INSTITUCIONES_TERMINACION";
     ...
     * @param contadorAccionPersonalOtrasInstitucionesTerminacion contador de la accion de personal
     * @param logo archivo del logo de la institucion
     * @param textoResolucion
     */
    public GenerarAccionPersonalOtraInstitucionTerminacion(
            PersonalOtrasInstituciones personal,
            final String nombreUsuarioConectado,
            final String contadorAccionPersonalOtrasInstitucionesTerminacion,
            final byte[] logo,
            final String textoResolucion) {

        this.nombreUsuarioConectado = nombreUsuarioConectado;
        this.contadorAccionPersonal = contadorAccionPersonalOtrasInstitucionesTerminacion;
        this.logo = logo;
...
//        tablaInfoAccion.getDefaultCell().setBorder(1);
    ...
    private void agregarCuerpo(Document document)
        ...
        c1 = escribirCelda(personalOtrasInstituciones.getJustificacionSalida(), 10, Font.NORMAL, Element.ALIGN_LEFT,
        ...
        c2 = escribirCelda(
                "TERMINACIÓN DE COMISIÓN DE SERVICIOS CON REMUNERACIÓN DE OTRA INSTITUCIÓN",
        ...
        c1 = escribirCelda("DIRECTORA DE RECURSOS HUMANOS",
                //        c1 = escribirCelda("\t",
                8, Font.BOLD, Element.ALIGN_CENTER, Rectangle.NO_BORDER, 0, 2);
        c1.setBorder(PdfPCell.LEFT | /*PdfPCell.BOTTOM |*/ PdfPCell.RIGHT);
        c1.setColspan(3);
        tabla.addCell(c1);
        //----------------------------------------------------------------------
        ...
        c21 = escribirCelda("RESPONSABLE DE TERMINACIÓN",
